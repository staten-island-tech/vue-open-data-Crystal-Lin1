<template>
    <div class="fixed inset-0 bg-gray-900/50 z-10">
        <div class="bg-white shadow-lg w-[50%] p-8 m-auto mt-10 rounded-2xl border border-gray-100">
...
import {selectedBoros} from '@/store/functions'
